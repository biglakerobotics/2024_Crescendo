...
public class TunerConstants {
    ...
    private static final Slot0Configs steerGains = new Slot0Configs()
        ...
        .withKS(0.14641).withKV(0.004).withKA(0.004);
    ...
    public static class ShooterConstants{
        //Testing needed V (Y)
        public static final double TOPSHOOTERSPEED = 1;
        ...
        //Testing needed V (B)
        public static final double TTOPSHOOTERSPEED = .75;
        // -.35 ^
        public static final double TBOTTOMSHOOTERSPEED = -1;
        // .35 ^
        //Amp shooter V (RB)
...
//     }
    ...
    private static final double kFrontRightEncoderOffset = 0.022705078125;
    ...
    private static final double kBackLeftEncoderOffset = 0.123291015625;
